...
tidytemplate provides a custom [pkgdown](https://pkgdown.r-lib.org) template for tidyverse, r-lib, and tidymodels packages.  Please don't use it for your own package.

## Using tidytemplate

Add the following to `_pkgdown.yaml`, modifying as `{YOUR DOMAIN}` as needed
...
* tidymodels uses a different primary colour and a different rollup domain:
